...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-healthymanagerapplicationapp-alert'], {
          param: decodeURIComponent(res.headers['x-healthymanagerapplicationapp-params'].replace(/\+/g, ' ')),
        });
